...
function setup() {
  ...
  poli=Bodies.circle(50,200,20)
  World.add(world, poli);
...
function draw() {
  ...
  imageMode(CENTER)
  image(polygon_img,poli.position.x,poli.position.y,40,40);

}

function mouseDragged(){
  Matter.Body.setPosition(this.poli.body,{x:mouseX,y:mouseY});
}
